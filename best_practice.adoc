:Title: Volume 14 OGC CDB Guidance on Conversion of CDB Shapefiles into CDB GeoPackages (Best Practice)
:titletext: Volume 14 OGC CDB Guidance on Conversion of CDB Shapefiles into CDB GeoPackages (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/CDB-gpkg/1.3
|Internal reference number of this OGC(R) document:    19-066r1
|Version: 1.3
|Category: OGC(R) Best Practice
|Editor:   Michala Hill, David Graham
|===
